...
public class Main {
    public static void main(String[] args) {
        ...
        ArrayList<PaperInfo> found = (ArrayList<PaperInfo>) catalog.searchByTitle("Supernatural");

        ArrayList<Book> authorBooks = (ArrayList<Book>) catalog.searchBooksByAuthor("Stephen King");
